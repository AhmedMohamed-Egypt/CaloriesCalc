function calculteRevised(gender, calories, kJoules, weight, height, age,toggleState,heightInch) {
  ...
  if (gender === "male") {
    const value = 13.397 * modifiedWeight + 4.799 * modifiedHeight - 5.677 * age + 88.362
    BMR = calories
      ? (value * (calories || 1)).toFixed(1)
      : (value * (kJoules || 1)).toFixed(1);
  }
  if (gender === "female") {
    //BMR = 9.247W + 3.098H - 4.330A + 447.593
    const value = 9.247 * modifiedWeight + 3.098 * modifiedHeight - 4.33 * age + 447.593;
    BMR = calories
      ? (value * (calories || 1)).toFixed(1)
      : (value * (kJoules || 1)).toFixed(1);
  }
