...
function Setting() {
  const {collectuserObject,userObject} = UseCalories()
    return (
      ...
      <Radio id={'mifflin'} name={'bmrCalc'} value={'mifflin'} onChange={(e)=>collectuserObject({...userObject,equation:e.target.value})} title={'Mifflin St Jeor'}/>
      <Radio id={'revised'} name={'bmrCalc'} value={'revised'} onChange={(e)=>collectuserObject({...userObject,equation:e.target.value})} title={'Revised Harris-Benedict'}/>
      <div className="d-flex align-items-center ">
      <Radio id={'katch'} name={'bmrCalc'} value={'katch'} onChange={(e)=>collectuserObject({...userObject,equation:e.target.value})} title={'katch'}/>
